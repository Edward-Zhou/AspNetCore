...
{
    public class CustomCollectionModelBinder<TElement> : ICollectionModelBinder
    {
        ...
        public CustomCollectionModelBinder(IModelBinder elementBinder)
        ...
        public CustomCollectionModelBinder(IModelBinder elementBinder, ILoggerFactory loggerFactory)
        {
